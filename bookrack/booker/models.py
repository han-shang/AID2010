...
#     user = models.ForeignKey(to='Novelrack', on_delete=models.CASCADE)
...
#查询：小说收藏表　小说收藏与用户一对一关系　用户查询通过一对一关系查询小说编号　在通过小说编号查询id  在通过ｉｄ查询小说详情
# 添加：直接ＵＲＬ获取小说编号　存入收藏表
# 删除：　　　
class Novelrack(models.Model):
    number_id = models.IntegerField('小说编号', default=num)
    name = models.CharField('名称', max_length=20,)
